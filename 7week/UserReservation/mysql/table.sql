...
-- select reservation_infos by user_email
...
where ri.user_id = (select id from user where email = 'carami@connect.co.kr');

-- select reservation_info_prices by user_email
...
select id from user where email = 'carami@connect.co.kr'));
